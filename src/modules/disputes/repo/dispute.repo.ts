...
// async function getAgentDisputeStats(agentId: string) {
//   const totalDisputes = await prisma.disputes.count({
//     where: { agent_id: agentId },
//   })
//   const openDisputes = await prisma.disputes.count({
//     where: { agent_id: agentId, status: "open" },
//   })
//   const closedDisputes = await prisma.disputes.count({
//     where: { agent_id: agentId, status: "closed" },
//   })
//   return {
//     totalDisputes,
//     openDisputes,
...
//   }
// }
// async function getCustomerDisputeStats(customerId: string) {
//   const totalDisputes = await prisma.disputes.count({
...
//   })
//   const closedDisputes = await prisma.disputes.count({
//     where: { customer_id: customerId, status: "closed" },
//   })
//   return {
//     totalDisputes,
//     openDisputes,
...
//   }
// }
// async function getDisputeByTransactionId(transactionId: string) {
//   return prisma.disputes.findMany({
//     where: { transaction_id: transactionId },
//   })
// }
// async function getDisputeByAgentId(agentId: string) {
//   return prisma.disputes.findMany({
//     where: { agent_id: agentId },
//   })
// }
// async function getDisputeByCustomerId(customerId: string) {
//   return prisma.disputes.findMany({
//     where: { customer_id: customerId },
//   })
// }
// async function getDisputeByStatus(status: string) {
//   return prisma.disputes.findMany({
//     where: { status },
//   })
// }
// async function getDisputeByType(type: string) {
//   return prisma.disputes.findMany({
//     where: { type },
//   })
// }
// async function getDisputeByCreatedAt(createdAt: Date) {
//   return prisma.disputes.findMany({
//     where: { created_at: createdAt },
//   })
// }
// async function getDisputeByUpdatedAt(updatedAt: Date) {
//   return prisma.disputes.findMany({
//     where: { updated_at: updatedAt },
//   })
// }
// async function getDisputeByResolutionNotes(resolutionNotes: string) {
//   return prisma.disputes.findMany({
//     where: { resolution_notes: resolutionNotes },
//   })
// }
// async function getDisputeByIsActive(isActive: boolean) {
//   return prisma.disputes.findMany({
//     where: { is_active: isActive },
//   })
// }
// async function getDisputeByCreatedAtRange(startDate: Date, endDate: Date) {
//   return prisma.disputes.findMany({
//     where: {
//       created_at: {
//         gte: startDate,
...
//   })
// }
// async function getDisputeByUpdatedAtRange(startDate: Date, endDate: Date) {
//   return prisma.disputes.findMany({
//     where: {
//       updated_at: {
//         gte: startDate,
...
export {
  ...
  deleteDispute,
  getDisputeStats,
  // getAgentDisputeStats,
  // getCustomerDisputeStats,
  // getDisputeByTransactionId,
  // getDisputeByAgentId,
  // getDisputeByCustomerId,
  // getDisputeByStatus,
  // getDisputeByType,
  // getDisputeByCreatedAt,
  // getDisputeByUpdatedAt,
  // getDisputeByResolutionNotes,
  // getDisputeByIsActive,
  // getDisputeByCreatedAtRange,
  // getDisputeByUpdatedAtRange,
}
